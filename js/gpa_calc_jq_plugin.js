...
(function ($) {
   var defaultSettings= {
      ...
      update_calc: function (ui) {
         ...
         ui.final_gpa.set_units((tot_units).toFixed(1));
		 $( "div.UNITS" ).text('Credits: ' + tot_units.toFixed(1));
		 ...
		 $( "div.GPAHIGH" ).text('GPA: ' + (tot_points_high / tot_units).toFixed(2));
		 $( "div.GRADE" ).text('GPA: ' + (tot_points_high / tot_units).toFixed(2));
         ui.final_gpa.set_gpa_low((tot_points_low / tot_units).toFixed(2));
		 $( "div.GPALOW" ).text('GPA: ' + (tot_points_low / tot_units).toFixed(2));
      }
   };
